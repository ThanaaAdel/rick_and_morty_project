class Character {
  ...
  Results? searchCharacterByName(String name) {
    // Use the firstWhere method to find the character by name
    try {
      return results.firstWhere((character) => character.name.toLowerCase() == name.toLowerCase());
    } catch (e) {
